...
namespace NFMsg
{
    ...
    public enum EGameMsgID
    {
      ...
      [global::ProtoBuf.ProtoEnum(Name=@"EGMI_REQ_GET_OBJECT_LIST", Value=30004)]
      EGMI_REQ_GET_OBJECT_LIST = 30004,
            
      [global::ProtoBuf.ProtoEnum(Name=@"EGMI_ACK_GET_OBJECT_LIST", Value=30005)]
      EGMI_ACK_GET_OBJECT_LIST = 30005,
            
      [global::ProtoBuf.ProtoEnum(Name=@"EGMI_REQ_OTHER_CLIENT_SHOW", Value=30006)]
      EGMI_REQ_OTHER_CLIENT_SHOW = 30006,
            
      [global::ProtoBuf.ProtoEnum(Name=@"EGMI_ACK_OTHER_CLIENT_SHOW", Value=30007)]
      EGMI_ACK_OTHER_CLIENT_SHOW = 30007
    }
